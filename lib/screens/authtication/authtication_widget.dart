...
import 'authtication_model.dart';
export 'authtication_model.dart';

class AuthticationWidget extends StatefulWidget {
  const AuthticationWidget({super.key});

  @override
  State<AuthticationWidget> createState() => _AuthticationWidgetState();
}

class _AuthticationWidgetState extends State<AuthticationWidget>
    with TickerProviderStateMixin {
  late AuthticationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthticationModel());
